 ...
 * @author user
 */
@WebServlet(name = "ViewTourController", urlPatterns = {"/ViewTourController"})
public class ViewTourController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Tbl_ToursDTO> list = dao.getListTour();
            if(list != null) {
                request.setAttribute("VIEW_TOUR_SUCCESS", list);
            } else {
                request.setAttribute("ERROR", "View Tours Failed! Tour not existed!");
            }
        } catch (Exception e) {
            log("ERROR at ViewTourController: " + e.getMessage());
        } finally {
