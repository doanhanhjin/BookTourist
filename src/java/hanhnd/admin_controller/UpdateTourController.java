 ...
 * @author user
 */
@WebServlet(name = "UpdateTourController", urlPatterns = {"/UpdateTourController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                Tbl_ToursDTO dto = new Tbl_ToursDTO(tourId, name, p, description, startDate, endDate, par, maxPar, cate, status, image);
                Tbl_ToursDAO dao = new Tbl_ToursDAO();
                dao.updateTour(dto);
                request.setAttribute("SUCCESS_UPDATE_TOUR", "Update Tours success!");
